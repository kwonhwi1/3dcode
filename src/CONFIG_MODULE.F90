MODULE CONFIG_MODULE
  ...
  TYPE T_CONFIG
    ...
    INTEGER :: NAXI,NSTEADY,NPMAX,NTMAX,BOND
    REAL(8) :: DT_PHY
    ...
    SUBROUTINE CONSTRUCT(CONFIG,EOS,PROP)
      ...
      DO N = 0,CONFIG%SIZE-1
        IF(N.EQ.CONFIG%RANK) THEN
          ...
          READ(IO,*); READ(IO,*) CONFIG%NAXI,CONFIG%NSTEADY,CONFIG%NPMAX,CONFIG%NTMAX,CONFIG%BOND,CONFIG%DT_PHY
